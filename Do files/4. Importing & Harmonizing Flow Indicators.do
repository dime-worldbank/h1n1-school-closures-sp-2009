	...
	*___________________________________________________________________________________________________________________________________________________* 
		...
		**
			...
			**
			*Ordem dos dados
			order     year region uf coduf codmunic municipality codschool school  location network 
			sort      codschool year codmunic coduf
			
			keep year codschool network location approval1grade-approvalEF repetition1grade-repetitionEF dropout1grade-dropoutEF
